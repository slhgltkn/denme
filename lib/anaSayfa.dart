    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Image.asset('assets/images/logoSeffaf.png'),
        ...
        bottomNavigationBar: BottomNavigationBar(
          items: const [
            BottomNavigationBarItem(
                icon:
                    Icon(Icons.home, color: Color.fromARGB(255, 186, 199, 204)),
                label: ""),
            BottomNavigationBarItem(
                icon: Icon(Icons.search,
                    color: Color.fromARGB(255, 186, 199, 204)),
                label: ""),
            BottomNavigationBarItem(
                icon:
                    Icon(Icons.add, color: Color.fromARGB(255, 186, 199, 204)),
                label: ""),
            BottomNavigationBarItem(
                icon:
                    Icon(Icons.send, color: Color.fromARGB(255, 186, 199, 204)),
                label: ""),
            BottomNavigationBarItem(
